...
namespace Code.Runtime.Common.Extensions
{
    internal static class VectorExtensions
    {
        ...
        public static Vector3 MultiplyX(this Vector3 v, float xDelta)
        {
            var tmp = v;
            tmp.x = tmp.x * xDelta;
            v = tmp;
        ...
        public static Vector3 MultiplyY(this Vector3 v, float yDelta)
        {
            var tmp = v;
            tmp.y = tmp.y * yDelta;
            v = tmp;
        ...
        public static Vector3 MultiplyZ(this Vector3 v, float zDelta)
        {
            var tmp = v;
            tmp.z = tmp.z * zDelta;
            v = tmp;
