...
public partial class GameEntity {
    ...
    static readonly Code.Runtime.Gameplay.Common.Movement.MovementAvailable movementAvailableComponent = new Code.Runtime.Gameplay.Common.Movement.MovementAvailable();
