...
public partial class GameEntity {
    ...
    public Code.Runtime.Gameplay.Common.Movement.Speed speed { get { return (Code.Runtime.Gameplay.Common.Movement.Speed)GetComponent(GameComponentsLookup.Speed); } }
    ...
    public GameEntity AddSpeed(float newValue) {
        ...
        var component = (Code.Runtime.Gameplay.Common.Movement.Speed)CreateComponent(index, typeof(Code.Runtime.Gameplay.Common.Movement.Speed));
