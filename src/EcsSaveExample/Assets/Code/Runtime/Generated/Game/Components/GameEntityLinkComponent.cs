...
public partial class GameEntity {
    ...
    public Code.Runtime.Gameplay.Common.EntityLink entityLink { get { return (Code.Runtime.Gameplay.Common.EntityLink)GetComponent(GameComponentsLookup.EntityLink); } }
    ...
    public GameEntity AddEntityLink(int newValue) {
        ...
        var component = (Code.Runtime.Gameplay.Common.EntityLink)CreateComponent(index, typeof(Code.Runtime.Gameplay.Common.EntityLink));
